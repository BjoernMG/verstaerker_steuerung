...
//
//      tft1.setFreeFont(NULL); // Set font to GLCD
...
// Call up the font using tft1.setTextFont()
#define GFXFF 1
#define GLCD  0
#define FONT2 2
#define FONT4 4
...
// Use the following when calling tft1.setFreeFont()
//
